...
import src.com._520it.pss.handler.BeanHandler;
import src.com._520it.pss.handler.BeanListHandler;
import src.com._520it.pss.handler.IResultSetHandler;
...
public class MemberDAOImpl implements IMemberDAO {
    ...
    public Member getMember(Long id) {
        ...
        Object[] array = new Object[] { id };
        // 调用模板中的方法，接收并强转
        // 创建IResultSetHandler的对象
        // IResultSetHandler handler = new MemberResultSetHandler();
        try {
            return JdbcTemplate.query(sql, new BeanHandler<Member>(Member.class), array);
    ...
    public List<Member> listAll() {
        ...
        //List<Member> list;
        try {
            return JdbcTemplate.query(sql, new BeanListHandler<Member>(Member.class));
            //return list;
        } catch (Exception e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
    ...
    private class MemberResultSetHandler implements IResultSetHandler<List<Member>> {

        @Override
        public List<Member> handle(ResultSet rs) throws Exception {
            // 这里要把查询出来的结果装到list集合里面
